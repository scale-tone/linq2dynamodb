...
namespace Linq2DynamoDb.DataContext.Tests.CachingTests
{
	...
	class PredefinedHashKeyCachingTests2
    {
        ...
        [Test]
        public void DataContext_Caching_FullIndexUpdatedByUserSpecificIndex()
        {
            ...
            userSpecificTable1.InsertOnSubmit
            (
                new UserEntity()
                {
                    RangeKey = rangeKey5,
            ...
            userSpecificTable1.RemoveOnSubmit(new UserEntity { RangeKey = rangeKey1 });
            userSpecificTable1.RemoveOnSubmit(new UserEntity { RangeKey = rangeKey3 });
            ctx.SubmitChanges();
